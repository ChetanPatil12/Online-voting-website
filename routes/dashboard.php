    ...
    <body>
            ...
            <div id="mainSection">
                <div id="profileSection">
                    <img src="../uploads/<?php echo $data['photo']?>" height="100" width="100"><br>
                    <b><span>Name : </span></b><?php echo $data['name'] ?><br><br>
                    <b><span>Mobile :</span> </b><?php echo $data['mobile'] ?><br><br>
                    <b><span>Address :</span> </b><?php echo $data['address'] ?><br><br>
                    <b><span>Status : </span></b><?php echo $status ?>
                </div>
                <div id="groupSection">
                    <?php
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                <div style="border-bottom: 1px solid #bdc3c7; margin-bottom: 10px" class="show">
                                <img style="float: right" src="../uploads/<?php echo $groups[$i]['photo']?>" height="80" width="80">
                                <b>Party Name : </b><?php echo $groups[$i]['name']?><br><br>
